      ...
      },
      {
        ...
        value: function handleComponentMount(node) {
          ...
          var _props2 = this.props,
            ...
            onCoordinateSelect = _props2.onCoordinateSelect,
            containerElement = _props2.containerElement,
            settings = (0, _objectWithoutProperties3.default)(_props2, [
              "mapElement",
              "onCoordinateSelect",
              "containerElement",
            ])

          var map = new google.maps.Map(node, settings)
